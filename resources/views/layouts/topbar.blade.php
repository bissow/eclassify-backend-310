                    ...
                    <div class="dropdown me-3">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                            ...
                            @foreach ($languages as $language)
                                ...
                                <li class="d-flex justify-content-between align-items-center px-2 py-1" data-language-code="{{ $language->code }}">
                            ...
                            <div class="avatar avatar-md2 flex-shrink-0">
                                @if(!empty(Auth::user()->getRawOriginal('profile')))
                                    <img
                                        ...
                                        alt="Profile"
                                        class="img-fluid rounded-circle" data-no-auto-error onerror="onErrorUserAvatar(event)" data-name="{{ Auth::user()->name }}">
