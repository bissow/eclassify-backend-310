        ...
        <div class="row">
                                ...
                                <div class="h-100 p-3 border rounded">
                                    ...
                                    <ul class="list-unstyled mb-0">
                                        <li class="mb-3 d-flex align-items-start">
                                            ...
                                            <span>{{__("Download current categories to get the existing data")}}</span>
                                        </li>
                                        <li class="mb-3 d-flex align-items-start">
                                            <i class="fas fa-check-circle text-success me-2 mt-1"></i>
                                        ...
                                        <li class="mb-3 d-flex align-items-start">
                                            <i class="fas fa-check-circle text-success me-2 mt-1"></i>
                                            <span>{{__("Meta Title, Meta Description and Meta Keywords are optional SEO fields (default language). Leave empty to keep existing values.")}}</span>
                                        </li>
            ...
            <div class="col-md-6">
                <div class="card shadow-sm">
                    <div class="card-header bg-warning text-dark">
                        <h5 class="mb-0 fw-bold">
                            <i class="fas fa-download me-2"></i> {{__("Download Current Categories & Image Gallery")}}
                        </h5>
                    </div>
                    <div class="card-body p-4">
                        <div class="row g-4">
                            <div class="col-md-6">
                                <div class="p-3 border rounded h-100">
                                    ...
                                    <p class="text-muted small mb-3">{{__("Download all existing categories to edit and update them")}}</p>
                                    <div class="d-grid gap-2">
                                        <a href="{{ route('category.bulk-update.download') }}" class="btn btn-warning">
                                            <i class="fas fa-file-csv me-2"></i> <span class="d-none d-sm-inline">{{__("Download Current Categories")}}</span><span class="d-sm-none">{{__("Download CSV")}}</span>
                                        </a>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="col-md-6">
                <div class="card shadow-sm">
                    ...
                    <div class="card-body p-4">
                        <form action="{{ route('category.bulk-update.process') }}" method="POST" enctype="multipart/form-data" id="bulkUpdateForm">
                            @csrf
                            <div class="row">
                                <div class="col-md-12">
                ...
                <div class="modal-content shadow-lg">
                    ...
                    <form id="galleryUploadForm" enctype="multipart/form-data">
                        ...
                        <div class="d-flex flex-column flex-sm-row gap-2">
                            ...
                            <button type="submit" class="btn btn-primary" id="galleryUploadBtn">
                        ...
                        <div class="form-text mt-2">
                            <i class="fas fa-info-circle me-1"></i>
                            {{__("You can select multiple images at once. Supported formats: JPG, JPEG, PNG (Maximum size: 5MB per image)")}}
                        </div>
                    </form>
                            </div>
                        </div>
