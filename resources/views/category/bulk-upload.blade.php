    ...
    <div class="page-title">
        <div class="row d-flex align-items-center">
            ...
            <div class="col-12 col-md-6 text-end">
                <a href="{{ route('category.index') }}" class="btn btn-secondary mb-0">
        ...
        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="h-100 p-3 border rounded">
                                    ...
                                    <ul class="list-unstyled mb-0">
                                        ...
                                        <li class="mb-3 d-flex align-items-start">
                                            <i class="fas fa-check-circle text-success me-2 mt-1"></i>
                                            <span>{{__("Parent Category ID is optional - leave empty for top-level categories")}}</span>
                                        </li>
                                        <li class="mb-0 d-flex align-items-start">
                                            <i class="fas fa-check-circle text-success me-2 mt-1"></i>
                                            <span>{{__("Slug will be auto-generated from name if not provided")}}</span>
                                        </li>
                                        <li class="mb-0 d-flex align-items-start mt-3">
                                            <i class="fas fa-check-circle text-success me-2 mt-1"></i>
                                            <span>{{__("Meta Title, Meta Description and Meta Keywords are optional SEO fields (default language). Leave empty to skip.")}}</span>
                                        </li>
                                        <li class="mb-0 d-flex align-items-start mt-3">
                            ...
                            <div class="h-100 p-3 border rounded">
                                ...
                                <div>
                                    ...
                                    <ul class="list-unstyled mb-0 small">
                                        ...
                                        <li class="mb-2">
                                            <i class="fas fa-dot-circle text-primary me-2"></i>
                                            <strong>{{__("Job Category:")}}</strong> 0 = {{__("No")}}, 1 = {{__("Yes")}}
                                        </li>
                                        <li class="mb-2">
                                            <i class="fas fa-dot-circle text-primary me-2"></i>
                                            <strong>{{__("Price Optional:")}}</strong> 0 = {{__("No")}}, 1 = {{__("Yes")}}
                                        </li>
                                        <li class="mb-0">
                                            <i class="fas fa-dot-circle text-primary me-2"></i>
                                            <strong>{{__("Featured:")}}</strong> 0 = {{__("No")}}, 1 = {{__("Yes")}}
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="h-100 p-3 border rounded">
                                    ...
                                    <ul class="list-unstyled mb-0">
                                        ...
                                        <li class="mb-3 d-flex align-items-start">
                                            <i class="fas fa-arrow-right text-info me-2 mt-1"></i>
                                            <span>{{__("Upload multiple images at once (JPG, PNG)")}}</span>
                                        </li>
                                        <li class="mb-3 d-flex align-items-start">
                                            <i class="fas fa-arrow-right text-info me-2 mt-1"></i>
                                        ...
                                        <li class="mb-0 d-flex align-items-start">
                                            <i class="fas fa-arrow-right text-info me-2 mt-1"></i>
                                            <span><strong>{{__("Format:")}}</strong> category/filename.jpg</span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="row g-4">
                            <div class="col-md-6 d-flex">
                                <div class="p-3 border rounded d-flex flex-column w-100">
                                    ...
                                    <div class="d-grid gap-2 mt-auto">
                                        <a href="{{ route('category.bulk-upload.example') }}" class="btn btn-success">
                            ...
                            <div class="col-md-6 d-flex">
                                <div class="p-3 border rounded d-flex flex-column w-100">
                                    ...
                                    <p class="text-muted small mb-3">{{__("Upload images and copy their paths to use in your CSV file. The gallery allows you to manage all category images in one place.")}}</p>
                                    <button type="button" class="btn btn-info w-100 mt-auto" data-bs-toggle="modal" data-bs-target="#editModal">
            ...
            <div class="col-md-6">
                <div class="card shadow-sm">
                    ...
                    <div class="card-body p-4">
                        <form action="{{ route('category.bulk-upload.process') }}" method="POST" class="create-form" enctype="multipart/form-data" id="bulkUploadForm" data-pre-submit-function="preBulkUploadFunction" data-success-function="successBulkUploadFunction">
                            @csrf
                            <div class="row">
                                <div class="col-md-12">
                            ...
                            <div class="card-body">
                               ...
                               <form id="galleryUploadForm" enctype="multipart/form-data">
                                    ...
                                    <div class="d-flex flex-column flex-sm-row gap-2">
                                        ...
                                        <button type="submit" class="btn btn-primary btn-m" id="galleryUploadBtn">
                                    ...
                                    <div class="form-text mt-2">
                                        <i class="fas fa-info-circle me-1"></i>
                                        {{__("You can select multiple images at once. Supported formats: JPG, JPEG, PNG (Max: 5MB)")}}
                                    </div>
                                </form>
                            </div>
                        </div>
...
<script>
        $(document).ready(function() {
            ...
            $('#galleryUploadForm').on('submit', function(e) {
                ...
                $.ajax({
                    url: '{{ route("category.bulk-upload.gallery.upload") }}',
                    type: 'POST',
                    data: formData,
                    processData: false,
                    contentType: false,
        ...
        function loadGalleryImages() {
            $.ajax({
                url: '{{ route("category.bulk-upload.gallery.list") }}',
                type: 'GET',
                success: function(response) {
        ...
        const submitBtn = $('#bulkUploadForm').find('button[type="submit"]');
        const originalBtnText = submitBtn.html();
        function preBulkUploadFunction() {
            submitBtn.html('<i class="fas fa-spinner fa-spin me-2"></i> {{__("Processing...")}}').attr('disabled', true);   
        }
        function successBulkUploadFunction(response) {
