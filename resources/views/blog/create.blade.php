                                    ...
                                    <div class="row">
                                        ...
                                        @if($isDefault)
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>{{ __("Slug") }} </label>
                                                    <input type="text" name="slug" class="form-control" data-parsley-pattern="^[a-z0-9]+(?:-[a-z0-9]+)*$">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                @if($isDefault)
                                                    <select name="tags[]" data-tags="true" data-placeholder="{{__("Tags")}}" data-allow-clear="true" class="select-search col-12 w-100" multiple="multiple" data-parsley-required="true"></select>
                                                @else
                                                    <select name="translations[{{ $lang->id }}][tags][]" data-tags="true" data-placeholder="{{__("Tags")}}" data-allow-clear="true" class="select-search col-12 w-100" multiple="multiple"></select>
                                                @endif
                                            </div>
                                        </div>
