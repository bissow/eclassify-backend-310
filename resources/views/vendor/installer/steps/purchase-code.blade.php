...
@section('step')
    ...
    @if(isset($error))
        <div class="bg-red-100 border-l-4 border-red-500 p-4 mb-3">
            <div class="flex">
                ...
                <div class="ml-3">
                    <p class="text-sm leading-5 text-red-700" style="line-height:1.6">
                        <style>
                            .installer-error a { color:#7f1d1d; font-weight:600; text-decoration:underline; }
                            .installer-error a:hover { color:#450a0a; }
                            .installer-error code { background:#fecaca; padding:1px 4px; border-radius:3px; }
                        </style>
                        <span class="installer-error">{!! $error !!}</span>
                    </p>
                </div>
            </div>
        </div>
    ...
    <form method="post" action="{{ route('install.purchase-code.post') }}">
        ...
        <div class="mb-3">
            ...
            <input class="appearance-none border rounded w-full py-2 px-3 text-gray-700 border-gray-200 leading-tight focus:outline-none focus:shadow-outline"
