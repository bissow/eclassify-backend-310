                            ...
                            <div class="card-body mt-3">
                                    ...
                                    <ul class="nav nav-tabs" role="tablist">
                                        ...
                                        <div class="tab-content mt-3">
                                            @foreach($languages as $key => $lang)
                                                @php
                                                    $langTranslations = $verification_field->translations->where('language_id', $lang->id);
                                                    $translatedName = optional($langTranslations->firstWhere('key', 'name'))->value;
                                                    $translatedValuesRow = $langTranslations->firstWhere('key', 'value');
                                                    $translatedValues = $translatedValuesRow ? $translatedValuesRow->value : [];
                                                ...
                                                <div class="tab-pane fade @if($key == 0) show active @endif" id="lang-{{ $lang->id }}" role="tabpanel">
                                                    ...
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text"
                                                            name="name[{{ $lang->id }}]"
                                                            class="form-control"
                                                            value="{{ $isEnglish ? $verification_field->name : ($translatedName ?? '') }}"
                                                    ...
                                                    @if($verification_field->type == 'radio' || $verification_field->type == 'checkbox' || $verification_field->type == 'select')                                                        
                                                        {{-- Field Values --}}
                                                        @php
                                                            $values = $isEnglish
                    ...
                    <div class="card-body">
                        @php
                            $cols = [
                                ...
                                ['field'=>'value','title'=>__('Value'),'align'=>'center','sortable'=>true],
                                ['field'=>'operate','title'=>__('Action'),'escape'=>false,'align'=>'center','sortable'=>false,'events'=>'verificationFieldValueEvents'],
                            ];
                        @endphp
                        <x-data-table
                            id="table_list"
                            :url="route('seller-verification.value.show', $verification_field->id)"
                            click-to-select
