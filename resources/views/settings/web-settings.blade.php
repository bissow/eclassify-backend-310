        ...
        <form class="create-form-without-reset" action="{{route('settings.store') }}" method="post" enctype="multipart/form-data" data-success-function="successFunction" data-parsley-validate>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        <input type="hidden" name="web_setup" value="1">

                        <div class="form-group col-md-6 col-lg-3">
                            <label for="web_url" class="form-label">{{ __('Web URL') }}</label>
                            <input id="web_url" name="web_url" type="url" class="form-control" placeholder="{{ __('Web URL') }}" value="{{ $settings['web_url'] ?? '' }}" required>
                        </div>

                        <div class="form-group col-md-6 col-lg-3 d-flex align-items-center justify-content-center flex-column">
