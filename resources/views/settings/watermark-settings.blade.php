...
@section('content')
    <section class="section">
        <form method="POST" action="{{ route('settings.watermark-settings-store') }}" data-parsley-validate class="create-form" data-success-function="formSuccessFunction" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-md-6">
                    <div class="card">
...
<script>
   ...
   function toggleWatermarkSettings() {
    ...
    const positionSelect = document.getElementById('position');
    const imageInput = document.getElementById('watermark_image');
