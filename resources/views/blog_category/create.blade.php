...
@section('content')
    <section class="section">
        ...
        <div class="row">
            <form action="{{ route('blog-category.store') }}" method="POST" data-parsley-validate enctype="multipart/form-data">
                @csrf
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">{{ __('Add Blog Category') }}</div>
                                            ...
                                            <div class="row mt-3">
                                                <div class="col-md-6">
                                                    <div class="form-check form-switch">
                                                        ...
                                                        <input class="form-check-input status-switch" type="checkbox" role="switch" id="isActiveSwitch" checked>
