...
class SellerController extends Controller
{
    ...
    public function show(Request $request)
    {
        try {
            ...
            $sql = SellerRating::with(['seller:id,name,profile', 'buyer:id,name,profile', 'item:id,name']);
    ...
    public function showReports(Request $request)
    {
        try {
            ...
            $sql = SellerRating::with(['seller:id,name,profile', 'buyer:id,name,profile', 'item:id,name'])->whereNotNull('report_status')->withTrashed();
