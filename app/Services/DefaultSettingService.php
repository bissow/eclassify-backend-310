...
class DefaultSettingService {
    ...
    public static function get() {
        ...
        return [
            ...
            ['name' => 'android_maintenance_mode', 'value' => 0, 'type' => 'string'],
            ['name' => 'ios_maintenance_mode', 'value' => 0, 'type' => 'string'],
            ['name' => 'web_maintenance_mode', 'value' => 0, 'type' => 'string'],
            ...
            ['name' => 'google_map_key', 'value' => '', 'type' => 'string'],
